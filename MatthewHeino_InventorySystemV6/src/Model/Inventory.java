...
public class Inventory {
    ...
    /** Holds all the parts that are currently in inventory. */ 
    private static ObservableList<Part> allParts =  FXCollections.observableArrayList();
    
    /** Holds all the products that are currently in inventory. */ 
    private static ObservableList<Product> allProducts = FXCollections.observableArrayList();
    
    /** ID for part or Product */
    ...
    /** Method that will update the part in the inventory. This method will 
     * receive the original index of the part and will set the updated part at 
     * the same locations.
     * <p>
     * <b>Post:</b> The part has been updated in the system with the new 
     * information. </p>
     * 
     * @param index  The index of the part to be updated.
     * @param selectedPart The new Part to be set in the parts list.
     */
    ...
    /** Method to update a product in the inventory system. This method will 
     * receive the original index of the product and will set the updated product at 
     * the same locations.
     * <p>
     * <b>Post:</b> The product has been updated in the system with the new 
     * information. </p>
     * 
     * @param index  The index of the product to be updated.
     * @param newProduct  The new Product to be set in the products list.
     */
    ...
    /** Method that returns a list of all the parts that are in the system.  All 
     * parts that are currently in this system will be returned.  Will also 
     ...
     * All parts that are currently in this system will be returned.  Will also 
     * return an empty list.
